...
data_file = Path(__file__).parent.parent / "html_data" / "get_overall_nirf_ranking_1_100_2024.html"
save_to = Path(__file__).parent.parent / "data" / "nirf_overall_1_100_2024.csv"
